                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('dashboard-trasanctions-update', $transaction->id) }}" method="POST"
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <template v-if="status == 'SHIPPING'">
                                                ...
                                                <div class="col-md-2">
                                                    <button class="btn btn-success btn-block mt-4">Update Resi</button>
                                                </div>
                                            </template>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12 text-right">
                                            <button class="btn btn-success btn-lg mb-4 mt-4 mr-4" type="submit">Save
                                                Now</button>
                                        </div>
                                    </div>
                                </form>
