                ...
                <div class="row">
                    ...
                    @forelse ($categories as $category)
                        <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up"
                            data-aos-delay="{{ $incrementCategories += 100 }}">
                    ...
                    @empty
                        <div class="col-12 text-center py-5" data-aos="fade-up" data-aos-delay="100">No Categories Found
                        </div>
                    @endforelse
                </div>
            </div>
        ...
        <section class="store-new-products">
            <div class="container">
                ...
                <div class="row">
                    ...
                    @empty
                        <div class="col-12 text-center py-5" data-aos="fade-up" data-aos-delay="100">No Products Found
                        </div>
                    @endforelse
                </div>
            </div>
